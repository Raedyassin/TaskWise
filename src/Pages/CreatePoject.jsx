    ...
    <div className="px-5 py-4">
      ...
      <div className="bg-tertiary  rounded-lg shadow-xl shadow-right ">
        <form className="p-5 grid" >
          ...
          <input className="mt-1 mb-2 px-2 py-1 rounded focus:outline-none focus:ring-2 focus:ring-card" placeholder="Enter Project Name..." id='1' type="text" name="projectName" />
          
          <label className="mt-1 font-bold" htmlFor="2">Project Description:</label>
          <textarea className="mt-1 mb-2 px-2 py-1 rounded focus:outline-none focus:ring-2 focus:ring-card" placeholder="Enter Project Description..." id='2' rows='7' name="projectDescription">
            </textarea>
